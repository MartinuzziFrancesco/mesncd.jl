...
rowgap!(mainf, 1, Fixed(-20))
rowgap!(mainf, 2, Fixed(-20))
colgap!(minesn, 0)
colgap!(esno, 0)
colgap!(esns, 0)
...
save("figures/mesncd_highlight.eps", fig, dpi=300)
save("figures/mesncd_highlight.png", fig, dpi=300)
